...
function calculateCurrency(){
        ...
        ***********************************************************************************************/                                                                                                               
        ...
        document.getElementById("currencyExchangeInfo").innerHTML="<center><h2>Selling $ " + parseFloat(usdAmount).toFixed(2) + " USD====> " + "Buys $ " +
            parseFloat(exchangeRate).toFixed(2) + " " + countryName + "<h/2></center>";
...
function clearButton () {
        ...
        *          is clicked.  The getElementById() method is used to fisnd the element on the HTML page with 
